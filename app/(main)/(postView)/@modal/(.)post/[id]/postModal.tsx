...
export default function PostModal(
    ...
    return (
        <motion.div className="bg-white/10 border-2 border-blue-100/15 rounded-3xl backdrop-blur-lg flex gap-5 absolute z-999 top-1/2 left-1/2 -translate-1/2 w-[90vw] h-[90vh] overflow-hidden"
